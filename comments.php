...
if( comments_open() ){
    ...
    if ( have_comments() ) {
        ...
        echo '<div class="techmoon-comments">';
        ...
        wp_list_comments( array(
            'callback' => array( 'techmoon_comments' , 'classic' ),
            'style' => 'ul' 
        ));
        ...
        if( !empty( $pgn ) ){
            ...
            echo '<nav class="techmoon-nav-inline">';
            echo $pgn;
            echo '</nav>';
            echo '</div>';    
        }
    ...
    if( (bool)get_theme_mod( 'techmoon-html-suggestions', true ) ){
        $rett .= '<div class="techmoon-html-suggestions">';
