 ...
 */
function techmoon_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter TechMoon default saturation level.
	 *
	 * @since TechMoon 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'techmoon_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.techmoon-front-page) .entry-title,
...
.colors-custom .techmoon-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.techmoon-front-page .panel-content .recent-posts article,
...
.colors-custom.techmoon-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters TechMoon custom colors CSS.
	 *
	 * @since TechMoon 1.0
	 *
	 ...
	 */
	return apply_filters( 'techmoon_custom_colors_css', $css, $hue, $saturation );
}
