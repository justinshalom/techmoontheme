<?php
if( !class_exists( 'techmoon_post_categories' ) ){

class techmoon_post_categories extends WP_Widget
{
    function __construct()
    {
        parent::__construct( 'techmoon_post_categories', __( 'Post Categories' , 'materialize' ) . ' [' . techmoon_core::author( 'name' ) . ']', array( 
...
register_widget( 'techmoon_post_categories' );
