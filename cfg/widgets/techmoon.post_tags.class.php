<?php
if( !class_exists( 'techmoon_post_tags' ) ){

class techmoon_post_tags extends WP_Widget
{
    function __construct()
    {
        parent::__construct( 'techmoon_post_tags', __( 'Post Tags' , 'materialize' ) . ' [' . techmoon_core::author( 'name' ) . ']', array( 
...
register_widget( 'techmoon_post_tags' );
