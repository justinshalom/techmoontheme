<?php
if( !class_exists( 'techmoon_post_meta' ) ){

class techmoon_post_meta extends WP_Widget
{
    function __construct()
    {
        parent::__construct( 'techmoon_post_meta', __( 'Post Meta' , 'materialize' ) . ' [' . techmoon_core::author( 'name' ) . ']', array( 
    ...
    {    
        ...
        if( $post -> comment_status == 'open' ) {
            ...
            echo sprintf( _nx( '%s Comment' , '%s Comments' , absint( $nr ) , 'Number of comment(s) from widget "techmoon: Meta Details"' , 'materialize' ), number_format_i18n( absint( $nr ) ) );
            echo '</a></li>';
        }
...
register_widget( 'techmoon_post_meta' );
