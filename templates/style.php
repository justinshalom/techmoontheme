...
<style type="text/css" id="techmoon-breadcrumbs-space">
    <?php
        $space      = absint( get_theme_mod( 'techmoon-breadcrumbs-space', 60 ) );
...
<style type="text/css" id="techmoon-background-color">
    body > div.content{
...
<style type="text/css" id="techmoon-header-headline-color" media="all">
    div.techmoon-header a.header-headline{
        color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-headline-color', '#e53932' ) ); ?>
    }
</style>

<!-- header content description color and description hover color -->
<style type="text/css" id="techmoon-header-description-color" media="all">

    <?php
        $hex    = esc_attr( get_theme_mod( 'techmoon-header-description-color', '#000000' ) );
        $rgba1  = 'rgba( ' . techmoon_tools::hex2rgb( $hex ) . ', 0.55 )';
        $rgba2  = 'rgba( ' . techmoon_tools::hex2rgb( $hex ) . ', 1.0 )';
    ?>
...
<style type="text/css" id="techmoon-header-btn-1-color" media="all">
    div.techmoon-header.parallax-container div.techmoon-header-buttons a.btn-large.techmoon-first-button{
        color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-btn-1-color', '#ffffff' ) ); ?>;
    }
</style>

<!-- header first button background color -->
<style type="text/css" id="techmoon-header-btn-1-bkg-color" media="all">
    div.techmoon-header.parallax-container div.techmoon-header-buttons a.btn-large.techmoon-first-button{
        background-color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-btn-1-bkg-color', '#4caf50' ) ); ?>;
    }
</style>

<!-- header first button background hover color -->
<style type="text/css" id="techmoon-header-btn-1-bkg-h-color" media="all">
    div.techmoon-header.parallax-container div.techmoon-header-buttons a.btn-large.techmoon-first-button:hover{
        background-color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-btn-1-bkg-h-color', '#43a047' ) ); ?>;
    }
</style>

<!-- header second button -->
<!-- header second button text color -->
<style type="text/css" id="techmoon-header-btn-2-color" media="all">
    div.techmoon-header.parallax-container div.techmoon-header-buttons a.btn-large.techmoon-second-button{
        color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-btn-2-color', '#ffffff' ) ); ?>;
    }
</style>

<!-- header second button background color -->
<style type="text/css" id="techmoon-header-btn-2-bkg-color" media="all">
    div.techmoon-header.parallax-container div.techmoon-header-buttons a.btn-large.techmoon-second-button{
        background-color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-btn-2-bkg-color', '#e53935' ) ); ?>;
    }
</style>

<!-- header second button background hover color -->
<style type="text/css" id="techmoon-header-btn-2-bkg-h-color" media="all">
    div.techmoon-header.parallax-container div.techmoon-header-buttons a.btn-large.techmoon-second-button:hover{
        background-color: <?php echo esc_attr( get_theme_mod( 'techmoon-header-btn-2-bkg-h-color', '#d32f2f' ) ); ?>;
    }
</style>
