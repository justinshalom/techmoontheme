    ...
    <article <?php post_class(); ?>>
        ...
        ?>
                ...
                <div class="post-thumbnail overflow-wrapper">
                    ...
                    <a href="<?php echo get_permalink( $post -> ID ); ?>" class="valign-cell-wrapper" title="<?php echo techmoon_post::title( $post -> ID, true ); ?>">
                    </a>
        ...
        <h2 class="post-title">
            <?php if( !empty( $post -> post_title ) ) { ?>
                ...
                <a href="<?php the_permalink() ?>" title="<?php echo techmoon_post::title( $post -> ID, true ); ?>"><?php the_title(); ?></a>
