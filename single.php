                                ...
                                <?php
                                    ...
                                    if( !empty( $categories ) ){
                                        ...
                                        foreach( $categories as $c ){
                                            echo techmoon_breadcrumbs::categories( absint( $c -> term_id ) );
                                            break;
                                        }
                                    }
                                ?>
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <?php
                ...
                // get layout details
                $techmoon_layout = new techmoon_layout( 'post' );
            ...
            ?>
                ...
                ?>
                            ...
                            <?php
                                ...
                                wp_link_pages( array(
                                    'before'        => '<div class="techmoon-paged-post"><span class="techmoon-pagination-title">' . __( 'Pages', 'materialize' ) . ': </span>',
